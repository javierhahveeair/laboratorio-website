...
export default function LocationsPage() {
    ...
    if (hasError) {
        return (
            <div className="min-h-screen bg-gray-50 flex items-center justify-center">
                <div className="text-center">
                    <p className="text-red-600">Error al cargar el mapa: {errorMessage}</p>
                </div>
            </div>
        )
    }
    ...
    return (
        <>
            ...
            {/* Only render Script if we have an API key */}
            {MAPS_API_KEY ? (
                <Script
                    ...
                    onLoad={() => {
                        ...
                        // Don't log the API key presence
                        initializeMap();
                    }}
                    onError={() => {
                ...
                <div className="min-h-screen bg-gray-50 flex items-center justify-center">
                    <div className="text-center">
                        <p className="text-red-600">Error de configuración del mapa.</p>
                    </div>
                </div>
            )}
